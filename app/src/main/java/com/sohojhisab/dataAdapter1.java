...
public class dataAdapter1 extends ArrayAdapter<Contact> {
    ...
    public dataAdapter1(Context context, ArrayList<Contact> contact) {
        super(context, R.layout.expense_list_item, contact);
        this.context = context;
        this.mcontact = contact;
    }

    public class Holder {
        TextView date, info, edit, del, d, t, des;
        ImageView pic;
