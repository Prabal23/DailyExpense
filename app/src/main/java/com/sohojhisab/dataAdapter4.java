...
public class dataAdapter4 extends ArrayAdapter<Contact> {
    ...
    public dataAdapter4(Context context, ArrayList<Contact> contact) {
        super(context, R.layout.due_list_item, contact);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.due_list_item, parent, false);
