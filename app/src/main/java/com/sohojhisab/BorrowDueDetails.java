...
public class BorrowDueDetails extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.brw_due_det);
        ...
        if (st.equals("3")) {
            all_date = all_date.replace("1", "১").replace("2", "২").replace("3", "৩")
                    .replace("4", "৪").replace("5", "৫").replace("6", "৬").replace("7", "৭")
                    .replace("8", "৮").replace("9", "৯").replace("0", "০");
            title.setText("দেনার বিবরণ");
            date.setText("দেনার তারিখ : " + all_date);
        }
        if (st.equals("4")) {
            all_date = all_date.replace("1", "১").replace("2", "২").replace("3", "৩")
                    .replace("4", "৪").replace("5", "৫").replace("6", "৬").replace("7", "৭")
                    .replace("8", "৮").replace("9", "৯").replace("0", "০");
            title.setText("পাওনার বিবরণ");
            date.setText("পাওনার তারিখ : " + all_date);
        }
        amount.setText(amt1);
        src.setText(srcs);
        des.setText(desc);
        ...
        date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(BorrowDueDetails.this, R.style.DialogTheme,
        ...
        dp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                popup.show();*/
                @SuppressLint("RestrictedApi") MenuBuilder menuBuilder = new MenuBuilder(BorrowDueDetails.this);
                MenuInflater inflater = new MenuInflater(BorrowDueDetails.this);
                inflater.inflate(R.menu.menu_main, menuBuilder);
                @SuppressLint("RestrictedApi") MenuPopupHelper optionsMenu = new MenuPopupHelper(BorrowDueDetails.this, menuBuilder, view);
                    ...
                    public boolean onMenuItemSelected(MenuBuilder menu, MenuItem item) {
                        switch (item.getItemId()) {
                            case R.id.profile:
                                ...
                                return true;
                            case R.id.logout:
                                final Dialog dialog = new Dialog(BorrowDueDetails.this);
        ...
        refresh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                alert1.showDialog(BorrowDueDetails.this, id);
            }
        });
        ...
        public void showDialog(AppCompatActivity activity, final String job_apply_id) {
            ...
            yes.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    db.deleteContact(i);
                    if (p.equals("3")) {
                        Intent intent = new Intent(getBaseContext(), AllDue.class);
                        startActivity(intent);
                    }
                    if (p.equals("4")) {
                        Intent intent = new Intent(getBaseContext(), AllBorrow.class);
                        startActivity(intent);
                        //finish();
                    }
                    finish();
    ...
    public void submitRes() {
        ...
        if (all_date.equals("")) {
            if (st.equals("3")) {
                err.setText("দেনার তারিখ বাছাই করা হয়নি");
            }
            if (st.equals("4")) {
                err.setText("পাওনার তারিখ বাছাই করা হয়নি");
            }
            ...
            if (st.equals("3")) {
                err.setText("ফোন নাম্বার দেওয়া হয়নি");
            }
            if (st.equals("4")) {
                err.setText("ফোন নাম্বার দেওয়া হয়নি");
            }
