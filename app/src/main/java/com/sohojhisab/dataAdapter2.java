...
public class dataAdapter2 extends ArrayAdapter<Contact> {
    ...
    public dataAdapter2(Context context, ArrayList<Contact> contact) {
        super(context, R.layout.balance_list_item, contact);
