...
public class AddIncome extends AppCompatActivity {
    ...
    String text = "", inc_date = "", amt = "", srcs = "", desc = "", res = "0000-00-00,0,0,0", dd = "", incinc = "0", expexp = "0", balbal = "0";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(AddIncome.this, R.style.DialogTheme,
                        new DatePickerDialog.OnDateSetListener() {
                            ...
                            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                                ...
                                inc_date = sdf.format(calendar.getTime());
                                date.setText("আয়ের তারিখ : " + inc_date);
                                //date.setText("আয়ের তারিখ : " + year + "-" + d + "-" + day);
                                //inc_date = year + "-" + d + "-" + day;
                            }
                        }, mYear, mMonth, mDay);
        ...
        dp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                popup.show();*/
                @SuppressLint("RestrictedApi") MenuBuilder menuBuilder = new MenuBuilder(AddIncome.this);
                MenuInflater inflater = new MenuInflater(AddIncome.this);
                inflater.inflate(R.menu.menu_main, menuBuilder);
                @SuppressLint("RestrictedApi") MenuPopupHelper optionsMenu = new MenuPopupHelper(AddIncome.this, menuBuilder, view);
    ...
    private void verifyPermissions(){
        ...
        if(ContextCompat.checkSelfPermission(this.getApplicationContext(),
            ...
            //Toast.makeText(CameraShopping.this, "ইতিমধ্যে পার্মিশনগুলো নেওয়া হয়েছে!", Toast.LENGTH_SHORT).show();
        }else{
            ActivityCompat.requestPermissions(AddIncome.this, permissions, 1);
        }
    }
    ...
    public void submitRes() {
        ...
        if (inc_date.equals("")) {
            ...
            err.setText("টাকার উৎস দেওয়া হয়নি");
            err.setVisibility(View.VISIBLE);
            ...
            db1.addBalance(new Balance(inc_date, amt, "0", bt));
            db.addContacts(new Contact(inc_date, amt, srcs, desc, "1", photo));
            //dbcat.addCat(new Category(srcs));
            ...
            editor.putString("balance", inc_date + "," + itotal + "," + et + "," + +btotal);
